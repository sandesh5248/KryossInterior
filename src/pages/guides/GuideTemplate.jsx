            ...
            <div className="blog-body">
                <section style={{ marginBottom: '6rem' }}>
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        ...
                        <h2 className="blog-section-title">Design <em>Insights</em></h2>
                    </div>
                    ...
                    <div className="blog-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
                        <div className="blog-card" style={{ padding: '2rem' }}>
                            <h3 style={{ fontSize: '1.2rem', marginBottom: '1rem' }}>Getting Started with {category}</h3>
                        ...
                        <div className="blog-card" style={{ padding: '2rem' }}>
                            <h3 style={{ fontSize: '1.2rem', marginBottom: '1rem' }}>Top Trends in {category}</h3>
                            <p style={{ color: '#888', marginBottom: '1.5rem', lineHeight: 1.6 }}>
                        ...
                        <div className="blog-card" style={{ padding: '2rem' }}>
                            <h3 style={{ fontSize: '1.2rem', marginBottom: '1rem' }}>{category} Layout Ideas</h3>
                            <p style={{ color: '#888', marginBottom: '1.5rem', lineHeight: 1.6 }}>
