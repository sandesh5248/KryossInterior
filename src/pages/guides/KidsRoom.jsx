...
import { ShieldCheck, LayoutGrid, BookOpen, Archive, Palette, Baby, School, GraduationCap } from 'lucide-react';
  ...
  const ageGroups = [
    {
      ...
      icon: <Baby size={28} color="#c9a96e" />,
    ...
    },
    {
      ...
      icon: <School size={28} color="#c9a96e" />,
    ...
    },
    {
      ...
      icon: <GraduationCap size={28} color="#c9a96e" />,
  ...
  return (
    <div className="blog-page">
      ...
      <div className="blog-body">
        ...
        <section style={{ marginBottom: '6rem' }}>
          <h2 className="blog-section-title">Design by <em>Age Group</em></h2>
